...
class Personagem:
    ...
    def dormir(self):               #Repensar de outra maneira, ou remover.
        self.sujo = True
        self.fome = True
        self.medicado = False

class Publico:                         #Transporte da turnê
    def __init__(self):
        self.publico = 500
...
if(__name__ == "__main__"):
    ...
    while True:
        ...
        print(f'São {str(relogio)} do dia {str(dia)}. O seu show começa em #contagem regressiva, segundos!!!.')
        print(personagem)
        print("")
        print("Ações:")
